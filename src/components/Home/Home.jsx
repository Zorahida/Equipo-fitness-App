...
const Home = () => {
  return (
    <>
      ...
      <Servicios
        nombre="Soporte"
        explicacion='Si es tu primera vez, disfruta de nuestra "Personal Training Intro". Una sesión introductoria al entrenamiento personal en la que un entrenador personal cualificado te guiará en tu plan y objetivos. Así podrás dar tus primeros pasos dentro del mundo del fitness.'
        imagen="Soporte"
      />
