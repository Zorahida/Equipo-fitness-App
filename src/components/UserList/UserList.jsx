      ...
      <>
        <div className="container_user_list"key={usuario.id}>
          ...
          <ul className="user_list">
            ...
            <li><strong>Peso: </strong>{usuario.peso}</li>
            <button className="button_modify">
              <Link className="modify_link" to={`/UserModify/${usuario._id}`}>Modificar</Link>
            </button>
            <br />
            <button className="button_delete"onClick={() => deleteUser(usuario._id)}>
              Eliminar Usuario
            </button>
          </ul>
        </div>
