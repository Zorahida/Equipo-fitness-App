...
const Register = () => {
  ...
  return (
    <div className='plantilla-register'>
      ...
      <input class="register_input" typeclass='text' placeholder='Nombre' {...register('Nombre', {
        required:'El nombre es requerido.'
      })}/>
      {errors.Nombre && <p>{errors.Nombre.message}</p>}


      <input class="register_input" typeclass='text' placeholder='Apellido'{...register('Apellido', {
        required:'El Apellido es requerido.'
      })}/>
      {errors.Apellido && <p>{errors.Apellido.message}</p>}


      <input class="register_input" typeclass='text' placeholder='Mail'{...register('mail', {
      ...
      <input class="register_input" typeclass='number' placeholder='Edad'{...register('Edad', {
        required:'La edad es necesario.'
      })}/>
      {errors.Edad && <p>{errors.Edad.message}</p>}


      <input class="register_input" typeclass='text' placeholder='Contraseña' {...register('Contraseña', {
